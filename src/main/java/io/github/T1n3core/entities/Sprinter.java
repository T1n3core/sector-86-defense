...
/**
 * Simply a faster {@linkplain io.github.T1n3core.entities.Brawler Brawler}.
 */
public class Sprinter extends Entity implements Moves {
	public static final double MOVEMENT_SPEED = 4.0;
	private double preciseX;
	private double preciseY;

	public Sprinter(int x, int y) {
		super(x, y, ResourceCache.SPRINTER, Team.ENEMY);
		preciseX = x;
		preciseY = y;
	}
